                                ...
                                <form @submit.prevent="submit" class="container px-5 py-24 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.title" class="text-red-600">Le champ Titre est obligatoire.</div>
                                        </div>
                                        </div>
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.image" class="text-red-600">Le champ Image est obligatoire.</div>
                                        </div>
                                    </div>
