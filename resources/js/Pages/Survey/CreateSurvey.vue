                            ...
                            <div class="flex flex-wrap -m-4">
                                <form @submit.prevent="submit" class="container px-5 py-24 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-1/2">
                                        <div class="relative">
                                            <label for="picture" class="leading-7 text-sm text-gray-600">Image</label>
                                            <input type="file" accept="image/png, image/gif, image/jpeg" @input="form.picture = $event.target.files[0]" id="picture" name="picture" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                        </div>
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <label for="Category" class="leading-7 text-sm text-gray-600">Combien de questions shouaitez vous poser ?</label>
                                            <select v-model="selectNumber" type="select" id="category" name="category" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div v-for="number in selectNumber" class="p-2 w-full">
                                            <label for="Category" class="leading-7 text-sm text-gray-600">De quel type est votre question ?</label>
                                            <div class="flex flex-wrap">
                                            <div class="p-2 w-1/3">
                                                <input v-model="typeOfQuestion" :value="checked" type="radio" inputId="Text" name="Text" value="Text" />
                                                <label for="Text" class="ml-2">Text</label>
                                            </div>
                                            <div class="p-2 w-1/3">
                                                <input v-model="typeOfQuestion" type="radio" inputId="Select" name="Select" value="Select" />
                                                <label for="Select" class="ml-2">Select box</label>
                                            </div>
                                            <div class="p-2 w-1/3">
                                                <input v-model="typeOfQuestion" type="radio" inputId="SelectMultiple" name="SelectMultiple" value="SelectMultiple" />
