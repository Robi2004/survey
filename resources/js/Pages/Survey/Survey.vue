                    ...
                    <div class="container px-5 py-24 mx-auto">
                        <div class="flex flex-wrap -m-4">
                                ...
                                <form @submit.prevent="submit" class="container px-5 py-24 mx-auto">
                                    ...
                                    <h2 class="sm:text-2xl text-2xl text-center font-medium title-font mb-4 text-gray-900">Vos informations</h2>
                                    ...
                                    <div v-for="item in survey['questions']">
                                        ...
                                        <div v-if="item.type == 'Select'" class="p-2 w-full">
                                            <div class="relative">
                                                <label for="title" class="leading-7 text-sm text-gray-600">{{ item.content }}</label>
                                                <select type="select" id="answerSelect" name="answerSelect" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
